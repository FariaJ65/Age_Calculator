...
photo=PhotoImage(file="C:/Users/ahnaf/Documents/Pycharm Projects/Age_Calculator/age.png")
...
def calculateAge():
    ...
    day=  birthDate.day - today.day 
    Label(text=f"{nameValue.get()}, your age is {age} years {month} month {day} days",font=("Times New Roman", 25, "bold")).place(x=150,y=200)
